					...
					{[
						{
							...
							details: [
								...
								'Generated Byte Pair Encodings (BPEs) for the training dataset using Jtokkit and MapReduce.', 
								'Successfully deployed the pipeline on AWS EMR for distributed processing.',
